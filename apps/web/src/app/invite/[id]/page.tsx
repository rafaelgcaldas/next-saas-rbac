...
export default async function InvitePage({ params }: InvitePageProps) {
  ...
  const userIsAuthenticatedWithSameEmailFormInvite =
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm flex-col justify-center space-y-6">
        ...
        {userIsAuthenticatedWithSameEmailFormInvite && (
        ...
        {isUserAuthenticated && !userIsAuthenticatedWithSameEmailFormInvite && (
